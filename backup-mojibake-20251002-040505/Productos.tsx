        ...
        {picked ? (
          <div className="flex flex-wrap items-center gap-2">
            <div className="px-3 py-2 border rounded-lg bg-slate-50">
              ...
              <div className="text-xs text-slate-500">
                Unidad: {picked.unit || "�?""} · Costo/u: ${Number(picked.costPerUnit || 0).toLocaleString()}
              </div>
            </div>
                ...
                {filtered.map((it) => (
                  ...
                  >
                    <div>
                      ...
                      <div className="text-xs text-slate-500">Unidad: {it.unit || "�?""}</div>
                    </div>
                    <div className="text-xs text-slate-600">Costo/u: ${Number(it.costPerUnit || 0).toLocaleString()}</div>
                  </button>
                ))}
              </div>
            )}
