...
export default function DevSeed() {
  ...
  const run = async () => {
    ...
    // 2) Producto con tamaos y receta por tamao
    await addDoc(collection(db, "products"), {
      name: "frappe de cafe",
      category: "frappes",
      active: true,
      sizes: [
        { label: "pequeo", price: 6000, recipe: { [miloRef.id]: 30, [lecheRef.id]: 150 } },
      ...
      recipe: {}, // base vaca, se usan tamaos
    });

    setMsg(`Listo o.

Inventario y producto de prueba creados.
Ve a Men y aade por tamao; al pagar, debe descontar stock por receta.`);
  };
  ...
  return (
    <main className="p-4">
      <div className="rounded-2xl border bg-white shadow-sm p-6 space-y-4 max-w-xl">
        ...
        <p className="text-sm text-zinc-600">Crea inventario, producto y receta por tamao para pruebas.</p>
