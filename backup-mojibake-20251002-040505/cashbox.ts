...
/** Flags de confirmación de WhatsApp (Apertura sin foto en la app) */
 ...
 * - openingCash: primera apertura del día (por createdAt)
...
export async function getTodayCashSnapshot(
  ...
  // --- Apertura (openingCash) �?' primera del día por createdAt, filtrada por orgId
  let openingCash = 0;
  {
    const qOpen = query(
