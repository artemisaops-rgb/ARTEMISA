    ...
    <div className="container-app p-6 space-y-5">
      ...
      {openingStatus !== "open" && (
        <div className="rounded-xl border bg-amber-50 text-amber-700 px-4 py-3">
          Debes registrar la <b>Apertura</b> de hoy (checklist + doble confirmación de foto por WhatsApp)
      ...
      <div className="bg-white border rounded-2xl p-4 space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <button className="btn" onClick={() => { /* live por onSnapshot */ }}>
            Actualizar resumen
          </button>
        </div>
      </div>
